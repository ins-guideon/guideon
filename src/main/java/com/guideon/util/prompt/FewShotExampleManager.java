...
public class FewShotExampleManager {
    ...
    private static void initializeAnswerGenerationExamples() {
        ...
        기준확인.add(new FewShotExample(
                "ans-기준확인-002",
                "경조금은 얼마나 받을 수 있나요?",
                "경조금 지급 기준은 다음과 같습니다.\n\n복리후생비규정 제15조에 따르면:\n- 부모 사망: 50만원\n- 배우자 사망: 50만원\n- 자녀 사망: 30만원\n- 형제자매 사망: 20만원\n- 조부모 사망: 20만원\n\n예를 들어, 부모님이 돌아가신 경우 50만원의 경조금이 지급되며, 형제자매가 돌아가신 경우에는 20만원이 지급됩니다.\n\n단, 본인과의 관계를 증빙하는 서류가 필요합니다.",
                null,
                "복리후생비규정",
                "기준확인",
        ...
        기준확인.add(new FewShotExample(
                "ans-기준확인-003",
                "출장 일비는 얼마인가요?",
                "출장 일비는 지역에 따라 차등 지급됩니다.\n\n출장여비지급규정 제8조에 따르면:\n- 수도권: 5만원\n- 광역시: 4만원\n- 기타 지역: 3만원\n\n예를 들어, 서울이나 경기 지역으로 출장하는 경우 일비 5만원이 지급되며, 부산이나 대구 같은 광역시로 출장하는 경우에는 4만원이 지급됩니다.\n\n해외 출장의 경우 국가별로 별도 기준이 적용됩니다.",
                null,
                "출장여비지급규정",
                "기준확인",
                Arrays.asList("출장여비지급규정"),
        ...
        기준확인.add(new FewShotExample(
                "ans-기준확인-004",
                "야근 수당은 시간당 얼마인가요?",
                "야근 수당은 기본급의 150%를 지급합니다.\n\n취업규칙 제45조에 따르면:\n- 평일 야근: 시간당 기본급의 150%\n- 휴일 야근: 시간당 기본급의 200%\n- 심야 근무(22시 이후): 추가 50% 가산\n\n예를 들어, 시간당 기본급이 14,354원인 경우 평일 야근 2시간 시 수당은 14,354원 × 2시간 × 1.5 = 43,062원이 지급됩니다.\n\n최소 지급 단위는 1시간입니다.",
                null,
                "취업규칙",
                "기준확인",
                Arrays.asList("취업규칙"),
        ...
        정보조회.add(new FewShotExample(
                "ans-정보조회-001",
                "경조사에 대한 규정을 알려줘",
                "경조사 규정은 복리후생비규정과 취업규칙에 명시되어 있습니다.\n\n【경조휴가】\n복리후생비규정 제16조에 따르면:\n- 부모 사망: 5일\n- 배우자 사망: 5일\n- 자녀 사망: 3일\n- 형제자매 사망: 2일\n- 조부모 사망: 2일\n\n【경조금】\n복리후생비규정 제15조에 따르면:\n- 부모 사망: 50만원\n- 배우자 사망: 50만원\n- 자녀 사망: 30만원\n- 형제자매 사망: 20만원\n- 조부모 사망: 20만원\n\n예를 들어, 부모님이 돌아가신 경우 경조휴가 5일과 경조금 50만원이 지급되며, 형제자매가 돌아가신 경우에는 경조휴가 2일과 경조금 20만원이 지급됩니다.\n\n경조휴가는 경조사 발생일로부터 30일 이내 사용해야 하며, 미사용 시 소멸됩니다.",
                null,
                "복리후생비규정",
                "정보조회",
                Arrays.asList("복리후생비규정", "취업규칙"),
